...
import org.igsl.functor.OrderedFiniteSetNodeGenerator;
 ...
 */
public class OrderedDepthFirstTreeTraversal<T>
	implements TreeTraversal<T>, Copyable<OrderedDepthFirstTreeTraversal<T>>
{
	/**
	 ...
	 */
	public OrderedDepthFirstTreeTraversal(OrderedFiniteSetNodeGenerator<T> generator) 
	 ...
	 */
	public OrderedDepthFirstTreeTraversal<T> getCopyOf() {
		OrderedDepthFirstTreeTraversal<T> result = 
			new OrderedDepthFirstTreeTraversal<T>();
		return result;
	}
	...
	private OrderedDepthFirstTreeTraversal() {}
	
	protected OrderedFiniteSetNodeGenerator<T> generator;
	...
	private class PathIteratorImpl 
		...
		private OrderedDepthFirstTreeTraversal<T> tr;
		private int start, idx;

		public PathIteratorImpl(OrderedDepthFirstTreeTraversal<T> tr) {
			this.tr = tr;
			this.start = tr.depth;
			this.idx = this.start;
		}
